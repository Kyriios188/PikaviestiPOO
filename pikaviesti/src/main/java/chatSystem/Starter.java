 ...
 * (c'est la méthode addUser de UserList.java)
 ...
 * _Quand tu veux envoyer un message, appelle sendChatMessage du controller (je garantit pas que ça marche mais elle existe)
 *
 */
